 ...
 *****************************************************************************/
//
// $Id: SVGPolygonElementImpl.java 780 2001-03-27 17:24:21Z honkkis $
//
...
/**
 * SVGPolygonElementImpl is the implementation of
 * org.w3c.dom.svg.SVGPolygonElement
 */
public class SVGPolygonElementImpl extends SVGGraphic implements SVGPolygonElement, Drawable, BasicShape {
	 ...
	 *            should be recreated. Set this to true if the polygon has
	...
	public void draw(Graphics2D graphics, boolean refreshData) {
		...
		if (refreshData || polygon == null) { // regenerate all of the shapes
			...
			if (fillRule.equalsIgnoreCase("nonzero")) {
				polygon.setWindingRule(Path2D.WIND_NON_ZERO);
			} else {
