 ...
 * The interface allows registration and removal of <code>EventListeners</code>
...
public interface EventTarget {
	 ...
	 * <code>EventTarget</code> which is currently processing an event the new
	 * listener will not be triggered by the current event. <br>
	 ...
	 * removed listener will still be triggered by the current event. <br>
