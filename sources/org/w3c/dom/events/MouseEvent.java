...
public interface MouseEvent extends UIEvent {
	 ...
	 * a UI event. Currently this property is used with the mouseover event to
	 * indicate the <code>Node</code> which the pointing device exited and with
	 * the mouseout event to indicate the <code>Node</code> which the pointing
	 * device entered.
	 */
